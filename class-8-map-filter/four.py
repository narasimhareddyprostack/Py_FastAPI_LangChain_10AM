...
#write a python script, print all maruthi suzuki models
#write a python script, collect all maruthi suzuki models
#swift,Baleno

#print(list(map(lambda car:car['model'],list(filter(lambda car:car['brand']=="Maruthi Suzuki",cars)))))


maruthi_cars=list(filter(lambda car:car['brand']=="Maruthi Suzuki",cars))
print(maruthi_cars)

maruthi_models=list(map(lambda car:car['model'],maruthi_cars))
print(maruthi_models)